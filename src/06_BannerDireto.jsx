...
export const BannerDireto = () => {
    return (
        <div id="OndeComprar" className="flex flex-col items-center xl:flex-row m-auto bg-verde2 rounded-xl text-branco text-center xl:text-left p-6 w-5/6 min-h-[450px] md:w-5/6 xl:w-4/6 2xl:w-3/6 2xl:mt-8">
            <div>
                <img
